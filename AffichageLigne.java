    ...
    SpanLabel lb2;
         ...
         Resources theme;
          theme = UIManager.initFirstTheme("/theme");
           Button supp=new Button("supprimer");
            ImageViewer img=new ImageViewer(theme.getImage(c.getNomproduit()+".png"));
      ...
      //  ImageViewer img=new ImageViewer(theme.getImage(c.getImg()));
         ...
         Label l=new Label("Nom produit :"+String.valueOf(c.getNomproduit()));
          //Label l=new Label("Nom produit :"+String.valueOf(c.getNomproduit()));
          Label prix=new Label("Le prix :"+String.valueOf(c.getPrix()));
         
            Label tel=new Label("La quantite est :"+String.valueOf(c.getQuantite()));
            
              Label totale=new Label("Le Totale est :"+String.valueOf(c.getQuantite()*c.getPrix())+"dt");
           ...
           ser.supprimerLigne(c.getIdproduit()); ////supppppppppppprriiiiiiiiiiiiimer
            f.removeAll();
            ...
            public void actionPerformed(ActionEvent evt) {
              //  Dialog.show(String.valueOf(c.getIdpanier()),String.valueOf(c.getEtat()),"yes","no");
                ...
                bo.addActionListener(new ActionListener() {
                    ...
                    @Override
                    public void actionPerformed(ActionEvent evt) {
                       ser.ModifierLigne(c.getIdproduit(),Integer.valueOf(v.getText()));
                        HomeForm h=new HomeForm();
                          h.getF().show();
                    }
                });

...
public class ServicePanier {
    ...
    public void ajoutTask(panier ta) {
        ...
        String Url = "http://localhost/SMF1/web/app_dev.php/Panier/new?etat="+ta.getEtat()+"&idutilisateur="+ta.getIdutilisateur();// création de l'URL
    ...
    public void rechpanier(int id) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/SMF1/web/app_dev.php/Panier/find/"+id;// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
    ...
    public ArrayList<panier> getList2(){       
        ...
        con.setUrl("http://localhost/SMF1/web/app_dev.php/Panier/all");  
     ...
     public void supprimerpanier(int id) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/SMF1/web/app_dev.php/Panier/supprimerPanierm/"+id ;// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
      con.addResponseListener((e) -> {
            String str = new String(con.getResponseData());//Récupération de la réponse du serveur
            System.out.println(str);//Affichage de la réponse serveur sur la console
     ...
     public void Modifierpanier(int id,int etat) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/SMF1/web/app_dev.php/Panier/modifierPanierm?idpanier="+id+"&etat="+etat;// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion

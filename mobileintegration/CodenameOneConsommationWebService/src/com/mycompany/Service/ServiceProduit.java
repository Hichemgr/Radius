...
public class ServiceProduit {
               ...
               String nomproduit = obj.get("nomproduit").toString();
                ...
                float prix = Float.parseFloat(obj.get("prix").toString());
                  ...
                  float note = Float.parseFloat(obj.get("note").toString());
                   ...
                   e.setRef_prod((int) idproduit);
                    e.setNom_prod(nomproduit);
                     e.setPrix_prod(prix);
               e.setQuantite_prod((int) quantite);
                e.setRating_prod((int) note);
                 e.setDescription_prod(description);
    ...
    public ArrayList<Produit> getListprod(){       
        ...
        con.setUrl("http://localhost/SMF1/web/app_dev.php/Panier/allProduit");  

...
public class AffichageProduit {
    ...
    SpanLabel lb2;
      ...
      //  ImageViewer img=new ImageViewer(theme.getImage(c.getImg()));
         ...
         Label l=new Label("idproduit est :"+String.valueOf(c.getIdproduit()));
           Label nom=new Label("le nom est :"+String.valueOf(c.getNomproduit()));
            ...
            public void actionPerformed(ActionEvent evt) {
              //  Dialog.show(String.valueOf(c.getIdpanier()),String.valueOf(c.getEtat()),"yes","no");
                ...
                bo.addActionListener(new ActionListener() {
                    ...
                    @Override
                    public void actionPerformed(ActionEvent evt) {
                        ser.ajoutLigne(c.getIdproduit(),Integer.valueOf(v.getText()));

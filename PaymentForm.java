    ...
    public PaymentForm() {
        ...
        loginButton.addActionListener(e -> {
            ...
            if (Dialog.show("Complete Your Payment", "  Are you sure for Paying this contract ?", "Confirm", "Cancel")){
                ...
                ServiceLigneproduit p=new ServiceLigneproduit();
                long a=(long) p.getTotal(2);
              //  long x=Long.parseLong(a.getTotal());
                   long s = 222;
            order.setAmount(a*100);
            PaymentService ps = new PaymentService();
            ps.chargeCreditCard(order,"aa","mm");
            ToastBar.showMessage("Payment Succeeded !", FontImage.MATERIAL_CHECK);
           /// ReservationService r=new ReservationService();
            //r.supprimerAll(1);
           // CarteFAffiche ca = new CarteFAffiche(theme);
            //ca.show();
            }
            }

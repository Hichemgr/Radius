...
public class ProduitService {
     public void ajoutProduit(Produit p) {
        ...
        String Url = "http://localhost/SMF1/web/app_dev.php/produit/new?nomproduit="+ p.getNom_prod()+"&prix="+p.getPrix_prod()+"&quantite="+p.getQuantite_prod()+"&description="+p.getDescription_prod()+"&saison="+p.getSaison()+"&note="+p.getRating_prod()+"&imagep="+p.getImagep();// création de l'URL
 ...
 public ArrayList<Produit> parseListProduit(String json) {
    ...
    public ArrayList<Produit> getList2(){       
        ...
        con.setUrl("http://localhost/SMF1/web/app_dev.php/produit/all");  
    ...
    ArrayList<Produit> names = new ArrayList<>();
     public ArrayList<Produit> ProductName(){       
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/SMF1/web/app_dev.php/produit/ProductName");  
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                ProduitService pser = new ProduitService();
    ...
    public ArrayList<Produit> find(int id){       
        ConnectionRequest con = new ConnectionRequest();
        Produit p= new Produit();
        String Url = "http://localhost/SMF1/web/app_dev.php/produit/find/"+id;// création de l'URL
        con.setUrl(Url);
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
    ...
    public void supprimerProduit(int id) {
        ...
        float prix=p.getPrix_prod();
         String price = Float.toString(prix);
        String Url = "http://localhost/SMF1/web/app_dev.php/produit/supprimerProdMob/"+id;// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
...
//    }
        ...
        ConnectionRequest con = new ConnectionRequest();
        Produit p= new Produit();
        String Url = "http://localhost/SMF1/web/app_dev.php/produit/findByName/"+rech;// création de l'URL
        con.setUrl(Url);
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
...
Display.getInstance().sendMessage(new String[]{mailto},sujet,m);
 ...
 public void modifierProduit(Produit p) {
        ...
        int i=0;
         String price = Float.toString(prix);
        String Url = "http://localhost/SMF1/web/app_dev.php/produit/modifierProdMob?idproduit="+p.getRef_prod()+"&nomproduit="+ p.getNom_prod()+"&prix="+p.getPrix_prod()+"&quantite="+p.getQuantite_prod()+"&description="+p.getDescription_prod()+"&saison="+p.getSaison()+"&note="+p.getRating_prod()+"&imagep="+p.getImagep();// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion

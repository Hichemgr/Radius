   ...
   /* public void ajoutTask(panier ta) {
    ...
    public ArrayList<Produit> getListLigne(){       
        ...
        //con.setUrl("http://localhost/untitled/web/app_dev.php/Panier/allLigne");  
         con.setUrl("http://localhost/untitled/web/app_dev.php/Panier/cartm");  
     ...
     public void supprimerLigne(int id) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/untitled/web/app_dev.php/Panier/deletepan/"+id ;// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
      con.addResponseListener((e) -> {
            String str = new String(con.getResponseData());//Récupération de la réponse du serveur
            System.out.println(str);//Affichage de la réponse serveur sur la console
    ...
    public void ModifierLigne(int id,int qua) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/untitled/web/app_dev.php/Panier/modifpan/"+id+"?quantite="+qua;// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
     ...
     public void ajoutLigne(int idp,int q) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/untitled/web/app_dev.php/Panier/addpan/"+idp+"/"+q;// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
     ...
     public void valider(int idu) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/untitled/web/app_dev.php/Panier/validerm/"+idu;// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
      ...
      public void connect(String n,String p) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/untitled/web/app_dev.php/Panier/users?username="+n+"&password="+p;// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
      ...
      public void getTotale(int id) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/untitled/web/app_dev.php/Panier/totalm/"+id;// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
       ...
       public float getTotal(int idu) {
        ...
        notes = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/untitled/web/app_dev.php/Panier/totalm/" + idu);
